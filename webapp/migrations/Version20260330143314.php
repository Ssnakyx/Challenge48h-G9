 ...
 */
final class Version20260330143314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE geo_point (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, station_code VARCHAR(64) DEFAULT NULL, station_name VARCHAR(255) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, timestamp DATE NOT NULL, date DATE NOT NULL, created_at DATE NOT NULL)');
